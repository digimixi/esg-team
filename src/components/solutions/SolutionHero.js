...
const SolutionHero = ({ 
  ...
  if (isFullWidth) {
    return (
      <section className="relative h-[500px] flex items-center overflow-hidden border-b border-outline-variant bg-surface-container-high">
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin w-full flex flex-col items-center text-center">
          ...
          <h1 className="font-display-lg text-display-lg text-primary mb-stack-md">
            ...
            <span className="text-headline-md block text-secondary mt-2">{subtitle}</span>
          </h1>
  ...
  return (
    <section className="mb-stack-lg border border-outline-variant bg-surface-container-lowest p-stack-lg flex flex-col md:flex-row gap-gutter items-center overflow-hidden">
      <div className="flex-1 space-y-stack-md z-10">
        ...
        <h1 className="text-display-lg font-display-lg text-primary tracking-tight">
          {title} <span className="text-secondary font-light block md:inline">{subtitle}</span>
        </h1>
        ...
        {cta && (
          <div className="flex space-x-stack-md pt-stack-sm">
            <a href={cta.href} className="px-stack-lg py-3 bg-primary text-on-primary text-label-sm font-label-sm flex items-center gap-2 hover:bg-opacity-90 transition-all shadow-sm active:scale-95">
              {cta.label} <span className="material-symbols-outlined">arrow_forward</span>
            </a>
          </div>
        )}
      ...
      <div className="flex-1 w-full h-[320px] md:h-[400px] bg-surface-container-high rounded-lg overflow-hidden relative border border-outline-variant shadow-inner">
        <img 
